...
# Extract the values comes at rows 1 & 2 and columns 2 & 3 from the matrix y
...
#2.Let x <- list(a=5:10, c="Hello", d="AA"), write an R statement 
...
## Load/Read given csv file in R and and name it as 'oj'
## Load/Read  given excel file in R and and name it as 'Insurance'
## Load/Read  given json file in R and name it as 'data'